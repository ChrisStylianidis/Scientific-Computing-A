...
while (de-int(de))!=0:
    ...
    if de>1.0:
        de=de-int(de)
        ans2+=(10**c) ## check, kalitera na eftiaxnes mia lista me ta psifia 0 kai 1
                      ## sti swsti thesi... diskolo na to tsekarume kathws to apotelesma
                      ## vgeni kapws etsi : 1.010010100011101e+20
    c-=1
...
## check, i logiki fenete swsti, des tin lisi gia kaliteri parusiasi tu apotelesmatos
## grade : 8/10
