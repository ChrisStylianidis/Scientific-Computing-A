...
exit()
''' 
to file p xrisimopoieis opws les k einai auto tis ekfwnisis den to exeis stilei mazi me tis askisis s epomenws den mporw na to exw
pera apo auto exw dokimasei ena allo file k ola kala, kalo tha itan mellonika an xrisimopoieis kati g to programma s na to stelneis mazi
'''
#10/10